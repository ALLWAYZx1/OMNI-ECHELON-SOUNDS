export default function OmniEchelonSoundsWebsite() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-white/10">
          <div className="pointer-events-none absolute inset-0 opacity-80">
            {/* Big Bang core burst (pulsing energy) */}
          ...
          <div className="mx-auto flex min-h-[88vh] w-full max-w-6xl items-center px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      ...
      className="rounded-2xl border border-white/30 bg-gradient-to-r from-indigo-400/20 to-purple-400/20 px-6 py-3 text-sm font-semibold uppercase tracking-[0.22em] text-white"
        >
      Enter
      </button>
                  Enter
